...
public class Discotienda
{
    ...
    // -----------------------------------------------------------------
/**
 * Generar informe de discos en la discotienda 
 ...
 */
 ...
 // -----------------------------------------------------------------
    ...
    // -----------------------------------------------------------------
/**
 * Generar informe de los discos de pop y rock que sean economicos 
 * @throws FileNotFoundException - 
 */
    public void generarInformeCostoso() throws FileNotFoundException
    {
    	//Crear el directorio con la clase file 
    	   File directorio = new File ("./data/discosCostosos.txt");
        
      //crear la pluma para escribir el archivo 
    	PrintWriter pluma = new PrintWriter(directorio);
    	//Escribir con la pluma en el archivo 
    	pluma.println("Reporte de discos");
    	pluma.println("===========================================================================");
    	
    	// recorrido total de los dos generos utilizando un if dentro del for
    	
    	//for para recoorer los discos totalmente 
    	for(int x=0;x<discos.size();x++)
    	{
    		Disco miDisco = (Disco)discos.get(x); 
    	//utilizamos if para determinar que solo los generos pop y rock ingrecen dentro del ciclo si se cumple
    	//Dado el caso contrario este se borra 
    		if(miDisco.darGenero().equals("Pop")&& miDisco.darPrecioDisco()<1000.0||miDisco.darGenero().equals("Rock")&& miDisco.darPrecioDisco()<1000.0) 
    		{
    		   	// escribimos la pluma en el archivo
    			pluma.println("Nombre: " + miDisco.darNombreDisco() + 
    					      "Artista: " + miDisco.darArtista()+
    					      "Genero: " + miDisco.darGenero()+
    ...
    public String metodo1( )
    {
    	try {
     	   ...
     	   return "Ups! Se ha generado un error :( "+e.getMessage();
        }
    }
